...
class ProjectResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{projectId}";
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getCustomerId()).isEqualTo(DEFAULT_CUSTOMER_ID);
    ...
    void getAllProjects() throws Exception {
        ...
        restProjectMockMvc
            .perform(get(ENTITY_API_URL + "?sort=projectId,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].projectId").value(hasItem(project.getProjectId().intValue())))
    ...
    void getProject() throws Exception {
        ...
        // Get the project
        restProjectMockMvc
            .perform(get(ENTITY_API_URL_ID, project.getProjectId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.projectId").value(project.getProjectId().intValue()))
    ...
    void putNewProject() throws Exception {
        ...
        restProjectMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedProject.getProjectId())
        ...
        Project testProject = projectList.get(projectList.size() - 1);
        assertThat(testProject.getCustomerId()).isEqualTo(UPDATED_CUSTOMER_ID);
    ...
    void putNonExistingProject() throws Exception {
        int databaseSizeBeforeUpdate = projectRepository.findAll().size();
        project.setProjectId(count.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restProjectMockMvc
            .perform(
                put(ENTITY_API_URL_ID, project.getProjectId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.setProjectId(project.getProjectId());

        partialUpdatedProject.customerId(UPDATED_CUSTOMER_ID).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);

        restProjectMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedProject.getProjectId())
    ...
    void patchNonExistingProject() throws Exception {
        ...
        restProjectMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, project.getProjectId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(project))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteProject() throws Exception {
        ...
        // Delete the project
        restProjectMockMvc
            .perform(delete(ENTITY_API_URL_ID, project.getProjectId()).accept(MediaType.APPLICATION_JSON))
