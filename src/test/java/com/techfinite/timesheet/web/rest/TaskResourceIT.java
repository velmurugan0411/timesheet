...
class TaskResourceIT {
    ...
    void getTask() throws Exception {
        ...
        // Get the task
        restTaskMockMvc
            .perform(get(ENTITY_API_URL_ID, task.getTaskId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void putNewTask() throws Exception {
        ...
        restTaskMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTask.getTaskId())
    ...
    void putNonExistingTask() throws Exception {
        int databaseSizeBeforeUpdate = taskRepository.findAll().size();
        task.setTaskId(count.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restTaskMockMvc
            .perform(
                put(ENTITY_API_URL_ID, task.getTaskId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        restTaskMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTask.getTaskId())
    ...
    void patchNonExistingTask() throws Exception {
        ...
        restTaskMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, task.getTaskId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(task))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteTask() throws Exception {
        ...
        // Delete the task
        restTaskMockMvc
            .perform(delete(ENTITY_API_URL_ID, task.getTaskId()).accept(MediaType.APPLICATION_JSON))
