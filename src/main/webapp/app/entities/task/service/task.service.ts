...
export type PartialUpdateTask = Partial<ITask> & Pick<ITask, 'taskId'>;
...
export class TaskService {
  ...
  getTaskIdentifier(task: Pick<ITask, 'taskId'>): number {
    return task.taskId;
  }

  compareTask(o1: Pick<ITask, 'taskId'> | null, o2: Pick<ITask, 'taskId'> | null): boolean {
    return o1 && o2 ? this.getTaskIdentifier(o1) === this.getTaskIdentifier(o2) : o1 === o2;
  }

  addTaskToCollectionIfMissing<Type extends Pick<ITask, 'taskId'>>(
    taskCollection: Type[],
