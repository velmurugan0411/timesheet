...
describe('Customer routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ICustomer returned by find', () => {
      // GIVEN
      service.find = jest.fn(customerId => of(new HttpResponse({ body: { customerId } })));
      mockActivatedRouteSnapshot.params = { customerId: 123 };
      ...
      expect(resultCustomer).toEqual({ customerId: 123 });
    });
