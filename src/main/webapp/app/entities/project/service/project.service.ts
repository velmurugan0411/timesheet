...
export type PartialUpdateProject = Partial<IProject> & Pick<IProject, 'projectId'>;
...
export class ProjectService {
  ...
  getProjectIdentifier(project: Pick<IProject, 'projectId'>): number {
    return project.projectId;
  }

  compareProject(o1: Pick<IProject, 'projectId'> | null, o2: Pick<IProject, 'projectId'> | null): boolean {
    return o1 && o2 ? this.getProjectIdentifier(o1) === this.getProjectIdentifier(o2) : o1 === o2;
  }

  addProjectToCollectionIfMissing<Type extends Pick<IProject, 'projectId'>>(
