...
describe('Project Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Customer query and add missing value', () => {
      const project: IProject = { projectId: 456 };
      const customerId: ICustomer = { customerId: 60881 };
      project.customerId = customerId;

      const customerCollection: ICustomer[] = [{ customerId: 63039 }];
    ...
    it('Should update editForm', () => {
      const project: IProject = { projectId: 456 };
      const customerId: ICustomer = { customerId: 8927 };
      project.customerId = customerId;
  ...
  describe('save', () => {
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<IProject>>();
      const project = { projectId: 123 };
      jest.spyOn(projectFormService, 'getProject').mockReturnValue({ projectId: null });
